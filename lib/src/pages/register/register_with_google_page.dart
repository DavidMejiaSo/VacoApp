...
class RegisterWithGoogle extends StatefulWidget {
  ...
  @override
  State<RegisterWithGoogle> createState() => _RegisterWithFacebookState();
  String email, uid, fullName;
}
...
class _RegisterWithFacebookState extends State<RegisterWithGoogle> {
  @override
  void initState() {
    listAlerys = [];
    _getAlergy();
  ...
  void _googleRegister() async {
    ...
    dynamic respuestaRegistro = await registerService.registerGoogle(
      widget.fullName,
      widget.email,
      widget.uid,
      documentType,
              ...
              bottonAcept: ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  dynamic respuestaLogin = await loginService.login(
                      widget.email, widget.uid, tipoAcceso);
                  print("respuita del google $respuestaLogin");
